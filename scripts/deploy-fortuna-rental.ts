 ...
 */
async function main() {
  console.log("🚀 Deploying Fortuna Square Rental System with Delegate.cash...\n");
  ...
  console.log(`   npx hardhat verify --network apechain_curtis ${rentalAccountAddress}`);
  console.log(`   npx hardhat verify --network apechain_curtis ${rentalWrapperAddress} "${rentalAccountAddress}" "${ethers.ZeroAddress}"`);
  console.log(`   npx hardhat verify --network apechain_curtis ${rentalManagerAddress} "${rentalWrapperAddress}" "${feeRecipient}"`);
  console.log("\n" + "=".repeat(60));
}
